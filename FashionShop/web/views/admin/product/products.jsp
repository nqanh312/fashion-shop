                        ...
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li aria-current="page">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-sm font-medium text-gray-400 md:ml-2 dark:text-gray-500">Products</span>
                                </div>
                            </li>
                        </ol>
                    </nav>
                                        ...
                                        <c:forEach items="${products}" var="product">
                                            <tr class="hover:bg-gray-100" id="user-item-${product.getId()}">                                               
                                                ...
                                                <td class="py-4 px-6 text-sm font-medium text-center whitespace-nowrap">                                                   
                                                    ...
                                                    <a href="/admin/products/delete?id=${product.getId()}" class="ml-3 text-red-600 hover:underline">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
